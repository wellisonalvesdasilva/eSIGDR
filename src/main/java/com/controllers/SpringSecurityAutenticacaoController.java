...
public class SpringSecurityAutenticacaoController {

	/**
	 * Controller Spring Security: Acesso á tela de autenticação e aos demais
	 * JSP's pertencentes ao crud exemple
	 */
	@Autowired

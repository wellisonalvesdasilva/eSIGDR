				...
				<div class="card strpied-tabled-with-hover">
					...
					<div class="card-body">
						<form:form method="POST" modelAttribute="obj"
							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label>Nome</label> <input type="text" value='${obj.nome}'
											maxlength="40" minlength="1" id="nome" name="nome"
											class="form-control" placeholder="Nome">
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<label>Email</label> <input type="text" value='${obj.email}'
								...
								<div class="col-md-3">
									<div class="form-group">
										<label>CPF</label> <input type="text" value='${obj.cpf}'
											maxlength="40" minlength="1" id="cpf" name="cpf"
								...
								<div class="col-md-3">
									<div class="form-group">
										<label>Telefone</label> <input type="text"
											value='${obj.telefone}' maxlength="40" minlength="1"
								...
								<div class="col-md-3">
									<div class="form-group">
										<label>Telefone Recado</label> <input type="text"
											value='${obj.telefoneRecado}' maxlength="40" minlength="1"
							...
							<div class="row">
								<div class="col-md-5">
									<a name="btnSubmit" href='/e-SIGDR/home/cliente/consultar'
									...
									<a name="btnSubmit" href='/e-SIGDR/home/cliente/cadastrar'
